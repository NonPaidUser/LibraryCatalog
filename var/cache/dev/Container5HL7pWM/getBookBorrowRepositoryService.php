 ...
 */
class getBookBorrowRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BookBorrowRepository' shared autowired service.
     *
     * @return \App\Repository\BookBorrowRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BookBorrowRepository.php';

        return $container->privates['App\\Repository\\BookBorrowRepository'] = new \App\Repository\BookBorrowRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
