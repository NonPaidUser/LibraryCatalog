 ...
 */
class getNonPaidUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NonPaidUserRepository' shared autowired service.
     *
     * @return \App\Repository\NonPaidUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NonPaidUserRepository.php';

        return $container->privates['App\\Repository\\NonPaidUserRepository'] = new \App\Repository\NonPaidUserRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
