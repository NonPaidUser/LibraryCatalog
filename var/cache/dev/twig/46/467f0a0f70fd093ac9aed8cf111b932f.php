...
<div class=\"main-bar-tables\">
    <h1>";
        // line 48
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["page_title"]) || array_key_exists("page_title", $context) ? $context["page_title"] : (function () { throw new RuntimeError('Variable "page_title" does not exist.', 48, $this->source); })()), "html", null, true);
        yield "</h1>
    ...
    <table class=\"table-tables\">
        ...
        // line 73
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["user1"]) || array_key_exists("user1", $context) ? $context["user1"] : (function () { throw new RuntimeError('Variable "user1" does not exist.', 73, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            yield "</td>
                <td>";
            // line 76
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "name", [], "any", false, false, false, 76), "html", null, true);
            yield "</td>
                ";
            // line 78
            yield "                <td>";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["user"], "borrowedCount", [], "any", false, false, false, 78), "html", null, true);
            yield "</td>
                <td>
                    <a href=\"";
            // line 80
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 80)]), "html", null, true);
            yield "\">show</a> |
                    <a href=\"";
            // line 81
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_user_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 81)]), "html", null, true);
            yield "\">edit</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  271 => 89,  262 => 85,  260 => 84,  252 => 81,  248 => 80,  242 => 78,  238 => 76,  234 => 75,  231 => 74,  226 => 73,  219 => 68,  205 => 56,  202 => 55,  196 => 54,  185 => 52,  180 => 51,  176 => 50,  171 => 48,  164 => 44,  160 => 43,  156 => 42,  153 => 41,  146 => 32,  142 => 31,  136 => 28,  132 => 27,  126 => 24,  122 => 23,  116 => 20,  112 => 19,  106 => 16,  102 => 15,  92 => 8,  88 => 7,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
<div class=\"main-bar-tables\">
    ...
    <form class=\"form-container\" method=\"post\" action=\"{{ path('app_user_search') }}\">
        <label for=\"username\">Search user by full complete name to view their borrowed books</label><br>
        <input id=\"username\" name=\"username\" placeholder=\"Exact user name\" required>
        <button type=\"submit\">Find</button>
    </form>
