...
class __TwigTemplate_33b5b43806e1fb56426b5dc24e39e22d extends Template
{
    ...
    <p class=\"return_borrow1\">You have successfully borrowed: <strong>";
        // line 10
...
{% block body %}
    ...
    <p class=\"return_borrow1\">You have successfully borrowed: <strong>{{ book_title }}</strong> by <strong>{{ user_name }}</strong></p>
