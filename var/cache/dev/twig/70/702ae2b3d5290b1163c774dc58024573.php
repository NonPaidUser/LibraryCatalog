...
<div class=\"main-bar-tables\">
    ...
    <form class=\"form-container\" method=\"post\" action=\"";
        // line 56
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_return", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["book"]) || array_key_exists("book", $context) ? $context["book"] : (function () { throw new RuntimeError('Variable "book" does not exist.', 56, $this->source); })()), "id", [], "any", false, false, false, 56)]), "html", null, true);
        yield "\">
...
";
    ...
    {
        return array (  202 => 56,  199 => 55,  193 => 54,  182 => 52,  177 => 51,  173 => 50,  168 => 48,  163 => 46,  156 => 42,  153 => 41,  146 => 32,  142 => 31,  136 => 28,  132 => 27,  126 => 24,  122 => 23,  116 => 20,  112 => 19,  106 => 16,  102 => 15,  92 => 8,  88 => 7,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
...
<div class=\"main-bar-tables\">
    ...
    <form class=\"form-container\" method=\"post\" action=\"{{ path('app_return', {id: book.id}) }}\">
        <label for=\"username\">Borrower Name</label><br>
        <input id=\"username\" name=\"username\" placeholder=\"Type exact user name\" required>
        <button type=\"submit\">Return</button>
    </form>
